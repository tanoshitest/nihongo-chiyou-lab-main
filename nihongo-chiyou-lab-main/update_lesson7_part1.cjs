...
const vocabularyUpdates = {
    'きります': [
        ...
        { jp: 'ナイフで肉を切ります。', vn: 'Cắt thịt bằng dao.', furigana: [{ kanji: '肉', reading: 'にく' }, { kanji: '切', reading: 'き' }] },
        { jp: '半分に切ります。', vn: 'Cắt làm đôi.', furigana: [{ kanji: '半分', reading: 'はんぶん' }, { kanji: '切', reading: 'き' }] },
        { jp: '細かく切ります。', vn: 'Cắt nhỏ.', furigana: [{ kanji: '細', reading: 'こま' }, { kanji: '切', reading: 'き' }] },
        { jp: '野菜を切ります。', vn: 'Cắt rau.', furigana: [{ kanji: '野菜', reading: 'やさい' }, { kanji: '切', reading: 'き' }] }
    ],
    'おくります': [
        ...
        { jp: '国の家族に送ります。', vn: 'Gửi cho gia đình ở nước.', furigana: [{ kanji: '国', reading: 'くに' }, { kanji: '家族', reading: 'かぞく' }, { kanji: '送', reading: 'おく' }] },
        { jp: 'ファクスを送ります。', vn: 'Gửi fax.', furigana: [{ kanji: '送', reading: 'おく' }] },
        { jp: 'メールを送ります。', vn: 'Gửi mail.', furigana: [{ kanji: '送', reading: 'おく' }] },
        { jp: '航空便で送ります。', vn: 'Gửi bằng đường hàng không.', furigana: [{ kanji: '航空便', reading: 'こうくうびん' }, { kanji: '送', reading: 'おく' }] }
    ],
    'かします': [
...
for (let i = 0; i < lines.length; i++) {
    ...
    if (inVocab && vocabEndPattern.test(line)) {
        inVocab = false;
        inLesson7 = false; // Stop after L7 vocab to save time/errors
    }
    ...
    if (inVocab) {
        ...
        if (match) {
            ...
            if (vocabularyUpdates[word]) {
                ...
                // Remove existing examples if any (rudimentary check, or just append)
