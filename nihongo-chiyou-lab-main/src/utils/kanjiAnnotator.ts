...
export const KANJI_DICT: Record<string, KanjiInfo> = {
    ...
    // === Lesson 26 / N4 Kanji Practice Exam additions ===
    "診て": { furigana: "みて", meaning: "khám bệnh", tip: "診(chẩn) → khám bệnh" },
    "診ます": { furigana: "みます", meaning: "khám bệnh" },
    "診": { furigana: "み", meaning: "khám bệnh" },
    "遅れて": { furigana: "おくれて", meaning: "trễ/muộn", tip: "遅(trì) → chậm trễ" },
    "遅れます": { furigana: "おくれます", meaning: "trễ/muộn" },
    "遅": { furigana: "おそ", meaning: "muộn" },
    "間に合います": { furigana: "まにあいます", meaning: "kịp thời gian", tip: "間(gian) + 合(hợp) → vừa kịp" },
    "間に合い": { furigana: "まにあい", meaning: "kịp" },
    "失くした": { furigana: "なくした", meaning: "đã mất", tip: "失(thất) → đánh mất" },
    "失くす": { furigana: "なくす", meaning: "đánh mất" },
    "失": { furigana: "しつ", meaning: "thất/mất" },
    "鍵": { furigana: "かぎ", meaning: "chìa khóa", tip: "金(vàng) + 鍵(kiện) → vật bằng kim loại để mở cửa" },
    "探して": { furigana: "さがして", meaning: "đang tìm", tip: "探(thám) → tìm kiếm" },
    "探します": { furigana: "さがします", meaning: "tìm kiếm" },
    "探": { furigana: "さが", meaning: "tìm" },
    "参加します": { furigana: "さんかします", meaning: "tham gia", tip: "参(tham) + 加(gia) → dự vào" },
    "参加": { furigana: "さんか", meaning: "tham gia" },
    "参": { furigana: "さん", meaning: "tham" },
    "加": { furigana: "か", meaning: "gia" },
    "申し込みます": { furigana: "もうしこみます", meaning: "đăng ký", tip: "申(thân) + 込(vào) → trình bày để vào" },
    "申し込む": { furigana: "もうしこむ", meaning: "đăng ký" },
    "申し": { furigana: "もうし", meaning: "thưa/trình" },
    "申": { furigana: "もう", meaning: "thân/trình" },
    "都合": { furigana: "つごう", meaning: "điều kiện/sự thuận tiện", tip: "都(đô)+合(hợp) → điều kiện tiện lợi" },
    "都": { furigana: "つ", meaning: "đô" },
    "気分": { furigana: "きぶん", meaning: "tâm trạng/sức khỏe", tip: "気(khí)+分(phần) → trạng thái tinh thần" },
    "新聞社": { furigana: "しんぶんしゃ", meaning: "tòa soạn báo", tip: "新(tân)+聞(văn)+社(xã) → nơi làm báo" },
    "労働": { furigana: "ろうどう", meaning: "lao động" },
    "働いて": { furigana: "はたらいて", meaning: "đang làm việc" },
    "働く": { furigana: "はたらく", meaning: "làm việc" },
    "働": { furigana: "はたら", meaning: "làm" },
    "運動会": { furigana: "うんどうかい", meaning: "đại hội thể thao", tip: "運(vận)+動(động)+会(hội) → buổi tập thể thao" },
    "運動": { furigana: "うんどう", meaning: "vận động" },
    "運": { furigana: "うん", meaning: "vận" },
    "動": { furigana: "どう", meaning: "động" },
    "所": { furigana: "しょ", meaning: "sở/chỗ" },
    "今度": { furigana: "こんど", meaning: "lần này/lần tới", tip: "今(kim)+度(độ) → thời điểm này" },
    "度": { furigana: "ど", meaning: "độ/lần" },
    "直接": { furigana: "ちょくせつ", meaning: "trực tiếp", tip: "直(trực)+接(tiếp) → không qua trung gian" },
    "直": { furigana: "ちょく", meaning: "trực" },
    "接": { furigana: "せつ", meaning: "tiếp" },
    "片づきました": { furigana: "かたづきました", meaning: "đã dọn dẹp xong", tip: "片(phiến)+付(phó) → dọn sạch một bên" },
    "片づく": { furigana: "かたづく", meaning: "được dọn dẹp" },
    "片": { furigana: "かた", meaning: "phiến/một bên" },
    "出します": { furigana: "だします", meaning: "đưa ra/vứt rác", tip: "出(xuất) → lôi ra ngoài" },
    "出し": { furigana: "だし", meaning: "đưa ra" },
    "燃えます": { furigana: "もえます", meaning: "cháy được", tip: "燃(nhiên) → bắt lửa" },
    "燃え": { furigana: "もえ", meaning: "cháy" },
    "燃": { furigana: "も", meaning: "nhiên" },
    "置き場": { furigana: "おきば", meaning: "nơi để/đặt", tip: "置(trí)+場(trường) → nơi đặt đồ" },
    "置": { furigana: "お", meaning: "trí/đặt" },
    "横": { furigana: "よこ", meaning: "bên cạnh/chiều ngang", tip: "横(hoành) → nằm ngang" },
    "空き": { furigana: "あき", meaning: "trống/rỗng" },
    "瓶": { furigana: "びん", meaning: "cái chai", tip: "瓶(bình) → đồ bằng sứ/thủy tinh đựng nước" },
    "缶": { furigana: "かん", meaning: "cái lon", tip: "缶(phẫu) → hộp kim loại" },
    "連絡": { furigana: "れんらく", meaning: "liên lạc", tip: "連(liên)+絡(lạc) → kết nối với nhau" },
    "連": { furigana: "れん", meaning: "liên" },
    "絡": { furigana: "らく", meaning: "lạc" },
    "電子": { furigana: "でんし", meaning: "điện tử", tip: "電(điện)+子(tử) → hạt điện nhỏ" },
    "宇宙": { furigana: "うちゅう", meaning: "vũ trụ", tip: "宇(vũ)+宙(trụ) → không gian bao la" },
    "宇": { furigana: "う", meaning: "vũ" },
    "宙": { furigana: "ちゅう", meaning: "trụ" },
    "船": { furigana: "ふね", meaning: "con thuyền", tip: "船(thuyền) → phương tiện đi trên nước" },
    "別": { furigana: "べつ", meaning: "biệt/khác", tip: "別(biệt) → chia ra/khác đi" },
    "用": { furigana: "よう", meaning: "dùng" },
    "用心": { furigana: "ようじん", meaning: "cẩn thận" },
    "金曜日": { furigana: "きんようび", meaning: "thứ sáu" },
    "月曜日": { furigana: "げつようび", meaning: "thứ hai" },
};
