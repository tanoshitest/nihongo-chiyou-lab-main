...
import { ALL_TESTS, GRAMMAR_TESTS, Question } from "@/data/minnaTest3Data";
...
const MinnaTest3 = () => {
    ...
    // Debug logging
    useEffect(() => {
        console.log("MinnaTest3 Rendered");
        ...
        return (
            <Layout>
                <div className="container mx-auto px-4 py-8 text-center text-red-500">
                    ERROR: Cannot load exam data. Please check minnaTest3Data.ts
                </div>
            </Layout>
        );
    }
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-[#008001] mb-2">Bài Kiểm Tra 3 - N5</h1>
                <p className="text-muted-foreground mb-6">Tổng hợp kiến thức Bài 5 & 6</p>
