...
import { ALL_TESTS, ALL_GRAMMAR_TESTS, Question } from "@/data/minnaTest6Data";
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-[#008001] mb-2">Bài Kiểm Tra 6 - N5</h1>
                <p className="text-muted-foreground mb-6">Tổng hợp kiến thức Bài 11 & 12</p>
