...
import { ALL_TESTS, ALL_GRAMMAR_TESTS, Question } from "@/data/minnaTest12Data";
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-[#008001] mb-2">Bài Kiểm Tra 12 - N5</h1>
                <p className="text-muted-foreground mb-6">Tổng hợp kiến thức Bài 23, 24 & 25</p>
