        ...
        return (
            <Layout>
                <div className="container mx-auto px-4 py-8 text-center bg-red-50 p-6 rounded-lg">
                    ...
                    <Button onClick={() => navigate("/minna")} className="border-black text-black hover:bg-black/5">Quay lại danh sách</Button>
                </div>
            </Layout>
        );
    }
    ...
    const renderQuiz = (
        ...
        return (
            <div className="bg-white p-6 rounded-lg shadow-sm border space-y-6">
                ...
                {showResult && (
                    <div className="text-center p-4 bg-black/10 rounded-lg border border-black/20 animate-in fade-in zoom-in-95">
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <div className="mb-6">
                    <Button variant="ghost" className="mb-2 p-0 h-auto hover:bg-transparent hover:text-black" onClick={() => navigate("/minna")}>
                        ← Quay lại danh sách
                    </Button>
                    <h1 className="text-3xl font-bold text-black">Kiểm tra N4 - {testId}</h1>
