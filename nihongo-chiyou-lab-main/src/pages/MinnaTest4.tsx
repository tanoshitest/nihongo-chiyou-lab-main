...
import { ALL_TESTS, GRAMMAR_TESTS, Question } from "@/data/minnaTest4Data";

// Helper to parse Furigana text:
// 1. [先生|せんせい] -> <ruby>先生<rt>せんせい</rt></ruby> (actually rendered as text span with parens in this implementation)
...
const MinnaTest4 = () => {
    ...
    // Debug logging
    useEffect(() => {
        console.log("MinnaTest4 Rendered");
        ...
        return (
            <Layout>
                <div className="container mx-auto px-4 py-8 text-center text-red-500">
                    ERROR: Cannot load exam data. Please check minnaTest4Data.ts
                </div>
            </Layout>
        );
    }
    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-8">
                <h1 className="text-3xl font-bold text-[#008001] mb-2">Bài Kiểm Tra 4 - N5</h1>
                <p className="text-muted-foreground mb-6">Tổng hợp kiến thức Bài 7 & 8</p>
