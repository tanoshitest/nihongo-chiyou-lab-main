...
export const kanjiData: KanjiCard[] = [
  ...
  },
  {
    ...
    kanji: "万",
    lesson: 1,
    imageUrl: "/images/kanji/13_ten_thousand_3d.png",
    onyomi: "マン, バン",
    onyomiRomaji: "",
    kunyomi: "-",
    kunyomiRomaji: "",
    ...
    sinoVietnamese: "VẠN",
    radicals: "一 (nhất) + 刀 (đao)",
    mnemonic: "Một (一) nhát dao (刀) cắt đứt vạn (万) mối sầu.",
    examples: [
      {
        japanese: "一万円",
        romaji: "Ichimanen",
  ...
  },
  {
    ...
    kanji: "円",
    lesson: 1,
    imageUrl: "/images/kanji/14_yen_3d.png",
    onyomi: "エン",
    onyomiRomaji: "",
    kunyomi: "まる.い",
    kunyomiRomaji: "",
    ...
    sinoVietnamese: "VIÊN",
    radicals: "冂 (khuynh)",
    mnemonic: "Cái mũ (冂) hình tròn như đồng Yên (円).",
    examples: [
      {
        japanese: "百円",
        romaji: "Hyakuen",
  ...
  },
  {
    ...
    kanji: "口",
    lesson: 1,
    imageUrl: "/images/kanji/15_mouth_3d.png",
    onyomi: "コウ、ク",
    onyomiRomaji: "kou, ku",
    kunyomi: "くち",
    kunyomiRomaji: "kuchi",
  ...
  },
  {
    ...
    kanji: "目",
    lesson: 1,
    imageUrl: "/images/kanji/16_eye_3d.png",
    onyomi: "モク",
    onyomiRomaji: "moku",
    kunyomi: "め",
    kunyomiRomaji: "me",
  ...
  },
  {
    ...
    kanji: "日",
    lesson: 2,
    imageUrl: "/images/kanji/17_sun_3d.png",
    onyomi: "ニチ、ジツ",
  ...
  },
  {
    ...
    kanji: "月",
    lesson: 2,
    imageUrl: "/images/kanji/18_moon_3d.png",
    onyomi: "ゲツ、ガツ",
  ...
  },
  {
    ...
    kanji: "火",
    lesson: 2,
    imageUrl: "/images/kanji/19_fire_3d.png",
    onyomi: "カ",
    onyomiRomaji: "ka",
    kunyomi: "ひ",
    kunyomiRomaji: "hi",
  ...
  },
  {
    ...
    kanji: "水",
    lesson: 2,
    imageUrl: "/images/kanji/20_water_3d.png",
    onyomi: "スイ",
    onyomiRomaji: "sui",
    kunyomi: "みず",
    kunyomiRomaji: "mizu",
  ...
  },
  {
    ...
    kanji: "木",
    lesson: 2,
    imageUrl: "/images/kanji/21_tree_3d.png",
    onyomi: "モク、ボク",
  ...
  },
  {
    ...
    kanji: "金",
    lesson: 2,
    imageUrl: "/images/kanji/22_gold_3d.png",
    onyomi: "キン、コン",
  ...
  },
  {
    ...
    kanji: "土",
    lesson: 2,
    imageUrl: "/images/kanji/23_soil_3d.png",
    onyomi: "ド、ト",
    onyomiRomaji: "do, to",
    kunyomi: "つち",
  ...
  },
  {
    ...
    kanji: "曜",
    lesson: 2,
    imageUrl: "/images/kanji/24_weekday_3d.png",
    onyomi: "ヨウ",
    kunyomi: "",
  ...
  },
  {
    ...
    kanji: "本",
    lesson: 2,
    imageUrl: "/images/kanji/25_book_3d.png",
    onyomi: "ホン",
    onyomiRomaji: "hon",
    kunyomi: "もと",
    kunyomiRomaji: "moto",
  ...
  },
  {
    ...
    kanji: "人",
    lesson: 2,
    imageUrl: "/images/kanji/26_person_3d.png",
    onyomi: "ジン、ニン",
  ...
  },
  {
    ...
    kanji: "今",
    lesson: 2,
    imageUrl: "/images/kanji/27_now_3d.png",
    onyomi: "コン, キン",
    onyomiRomaji: "",
    kunyomi: "いま",
    kunyomiRomaji: "",
    meaning: "Bây giờ, Kim",
    sinoVietnamese: "KIM",
    radicals: "人 (nhân) + ラ (ra?)",
    mnemonic: "Bây giờ (今) người (人) đang ở dưới mái nhà.",
    examples: [
      {
        japanese: "今",
        romaji: "Ima",
  ...
  },
  {
    ...
    kanji: "寺",
    lesson: 2,
    imageUrl: "/images/kanji/28_temple_3d.png",
    onyomi: "ジ",
    onyomiRomaji: "",
    kunyomi: "てら",
    kunyomiRomaji: "",
    ...
    mnemonic: "Đất (土) ở chùa (寺) tấc (寸) đất tấc vàng.",
    examples: [
      {
        japanese: "お寺",
        romaji: "Otera",
      ...
      },
      {
        japanese: "金閣寺",
        romaji: "Kinkakuji",
        vietnamese: "Chùa Vàng"
      },
      {
        japanese: "山寺",
        romaji: "Yamadera",
        vietnamese: "Chùa trên núi"
      },
      {
        japanese: "寺院",
        romaji: "Jiin",
  ...
  },
  {
    ...
    mnemonic: "Mặt trời (日) chiếu lên ngôi chùa (寺) để báo giờ (時).",
    examples: [
      {
        japanese: "時間",
        romaji: "Jikan",
  ...
  },
  {
    ...
    sinoVietnamese: "ĐAO",
    radicals: "刀 (đao)",
    mnemonic: "Hình dáng thanh đao sắc bén.",
    examples: [
      {
        japanese: "刀",
        romaji: "Katana",
  ...
  },
  {
    ...
    mnemonic: "Buổi chiều (夕) bói (ト) xem có nên ra ngoài (外) không.",
    examples: [
      {
        japanese: "外",
        romaji: "Soto",
  ...
  },
  {
    ...
    meaning: "Phải",
    sinoVietnamese: "HỮU",
    radicals: "ナ (bất) + 口 (khẩu)",
    mnemonic: "Tay phải cầm thìa đưa vào miệng (口) ăn cơm.",
    examples: [
      {
        japanese: "右",
        romaji: "Migi",
  ...
  },
  {
    ...
    kunyomi: "-",
    kunyomiRomaji: "",
    meaning: "Công (công trường)",
    sinoVietnamese: "CÔNG",
    radicals: "工 (công)",
    mnemonic: "Hình cái thước của người thợ (công nhân).",
    examples: [
      {
        japanese: "工場",
        romaji: "Koujou",
  ...
  },
  {
    ...
    meaning: "Trái",
    sinoVietnamese: "TẢ",
    radicals: "ナ (bất) + 工 (công)",
    mnemonic: "Tay trái giữ thước (工) để làm việc.",
    examples: [
      {
        japanese: "左",
        romaji: "Hidari",
  ...
  },
  {
    ...
    meaning: "Trước",
    sinoVietnamese: "TIỀN",
    radicals: "䒑 (thảo) + 月 (nguyệt) + 刂 (đao)",
    mnemonic: "Cắt (刂) cỏ (䒑) dưới ánh trăng (月) trước nhà.",
    examples: [
      {
        japanese: "前",
        romaji: "Mae",
  ...
  },
  {
    ...
    meaning: "Sau",
    sinoVietnamese: "HẬU",
    radicals: "彳 (xích) + 幺 (yêu) + 夂 (truy)",
    mnemonic: "Bước chân (彳) nhỏ (幺) đi chậm (夂) ở phía sau (hậu).",
    examples: [
      {
        japanese: "後ろ",
        romaji: "Ushiro",
  ...
  },
  {
    ...
    sinoVietnamese: "NGỌ",
    radicals: "干 (can)",
    mnemonic: "Nhìn giống con trâu (牛) nhưng đầu không thò lên (Ngọ - trưa).",
    examples: [
      {
        japanese: "午前",
        romaji: "Gozen",
  ...
  },
  {
    ...
    mnemonic: "Mặt trời (日) mọc sau cái cây (木) là hướng Đông.",
    examples: [
      {
        japanese: "東",
        romaji: "Higashi",
  ...
  },
  {
    ...
    sinoVietnamese: "TÂY",
    radicals: "西 (tây)",
    mnemonic: "Mặt trời lặn hướng Tây trông như tổ chim.",
    examples: [
      {
        japanese: "西",
        romaji: "Nishi",
  ...
  },
  {
    ...
    sinoVietnamese: "NIÊN",
    radicals: "父 (phụ)",
    mnemonic: "Hình ảnh người cha cầm gậy (hai nét trên).",
    examples: [],
  },
  {
    id: 61,
  ...
  },
  {
    ...
    meaning: "Xích, Đỏ",
    sinoVietnamese: "Xích",
    radicals: "土 (thổ) + 火 (hỏa) - biến thể",
    mnemonic: "Đất (土) bị nung bởi lửa (火) thành màu đỏ.",
    examples: [
      {
        japanese: "赤い",
        romaji: "Akai",
  ...
  },
  {
    ...
    mnemonic: "Ánh mặt trời (日) chiếu xuống (丿) màu trắng.",
    examples: [
      {
        japanese: "白い",
        romaji: "Shiroi",
  ...
  },
  {
    ...
    sinoVietnamese: "Hắc",
    radicals: "里 (lý) + 灬 (hỏa)",
    mnemonic: "Ngôi làng (里) bị lửa (灬) thiêu cháy thành màu đen.",
    examples: [
      {
        japanese: "黒い",
        romaji: "Kuroi",
  ...
  },
  {
    ...
    sinoVietnamese: "Sắc",
    radicals: "ク (bao) + 巴 (ba)",
    mnemonic: "Màu sắc đuôi (巴) được bao (ク) lại.",
    examples: [
      {
        japanese: "色",
        romaji: "Iro",
  ...
  },
  {
    ...
    sinoVietnamese: "Liệu",
    radicals: "米 (mễ) + 斗 (đấu)",
    mnemonic: "Đong gạo (米) bằng đấu (斗) để làm nguyên liệu.",
    examples: [
      {
        japanese: "料理",
        romaji: "Ryouri",
  ...
  },
  {
    ...
    mnemonic: "Đứng (立) dưới mặt trời (日) nghe âm thanh.",
    examples: [
      {
        japanese: "音",
        romaji: "Oto",
  ...
  },
  {
    ...
    radicals: "白 (bạch) + 幺 (yêu) + 木 (mộc)",
    mnemonic: "Màu trắng (白) nhỏ (幺) trên cây (木) tạo niềm vui.",
    examples: [
      {
        japanese: "楽しい",
        romaji: "Tanoshii",
  ...
  },
  {
    ...
    meaning: "Chân, Thật",
    sinoVietnamese: "Chân",
    radicals: "十 (thập) + 目 (mục) + 乚 + ハ (bát)",
    mnemonic: "Mười (十) con mắt (目) nhìn sự thật rõ ràng.",
    examples: [
      {
        japanese: "写真",
        romaji: "Shashin",
  ...
  },
  {
    ...
    mnemonic: "Vẽ một (一) cánh đồng (田) trong khung tranh (凵).",
    examples: [
      {
        japanese: "映画",
        romaji: "Eiga",
  ...
  },
  {
    ...
    mnemonic: "Trái tim (心) suy nghĩ về mảnh ruộng (田).",
    examples: [
      {
        japanese: "思います",
        romaji: "Omoimasu",
  ...
  },
  {
    ...
    sinoVietnamese: "Sở",
    radicals: "戸 (hộ) + 斤 (cân)",
    mnemonic: "Cây rìu (斤) để cạnh cửa (戸) ở nơi làm việc.",
    examples: [
      {
        japanese: "所",
        romaji: "Tokoro",
  ...
  },
  {
    ...
    sinoVietnamese: "Đô",
    radicals: "者 (giả) + 阝 (ấp)",
    mnemonic: "Người (者) tập trung đông đúc tại thành phố (阝).",
    examples: [
      {
        japanese: "東京都",
        romaji: "Toukyouto",
  ...
  },
  {
    ...
    mnemonic: "Vùng đất được rào lại (匚) và đánh dấu chéo (メ) là một khu.",
    examples: [
      {
        japanese: "区",
        romaji: "Ku",
  ...
  },
  {
    ...
    sinoVietnamese: "Thân",
    radicals: "田 (điền) + 丨 (cổn)",
    imageUrl: "/images/kanji/481_say_3d.png",
    mnemonic: "Con khỉ (申) đang nói (申) chuyện.",
    examples: [
      {
        japanese: "申します",
        romaji: "Moushimasu",
  ...
  },
  {
    ...
    sinoVietnamese: "Thần",
    radicals: "礻(kỳ) + 申 (thân)",
    imageUrl: "/images/kanji/482_god_3d.png",
    mnemonic: "Thần (神) đang nói (申) chuyện tại đền thờ (礻).",
    examples: [
      {
        japanese: "神様",
        romaji: "Kamisama",
  ...
  },
  {
    ...
    sinoVietnamese: "Dạng",
    radicals: "木 (mộc) + 羊 (dương) + 永 (vĩnh)",
    imageUrl: "/images/kanji/483_appearance_3d.png",
    mnemonic: "Hình dáng (様) của con cừu (羊) đứng cạnh cây (木) uống nước mãi (永).",
    examples: [
      {
        japanese: "～様",
        romaji: "Sama",
  ...
  },
  {
    ...
    imageUrl: "/images/kanji/485_investigate_3d.png",
    mnemonic: "Đi khắp chu vi (周) để hỏi (言) thăm điều tra (調).",
    examples: [
      {
        japanese: "調べます",
        romaji: "Shirabemasu",
  ...
  },
  {
    ...
    kanji: "査",
    lesson: 31,
    imageUrl: "/images/kanji/486_inspect_3d.png",
    onyomi: "サ",
    onyomiRomaji: "sa",
    kunyomi: "-",
    kunyomiRomaji: "-",
    meaning: "Kiểm tra, Tra xét",
    sinoVietnamese: "TRA",
    radicals: "木 (mộc) + 且 (thả)",
    mnemonic: "Kiểm tra (査) cái kệ (且) làm bằng gỗ (木).",
    examples: [],
  },
  {
    id: 487,
    kanji: "相",
    lesson: 31,
    imageUrl: "/images/kanji/487_mutual_3d.png",
    onyomi: "ソウ, ショウ",
    onyomiRomaji: "sou, shou",
    kunyomi: "あい",
    kunyomiRomaji: "ai",
    meaning: "Tương, Tương hỗ",
    sinoVietnamese: "TƯƠNG",
    radicals: "木 (mộc) + 目 (mục)",
    mnemonic: "Mắt (目) quan sát cây (木) là xem tướng (相).",
    examples: [],
  },
  {
    id: 488,
    ...
    imageUrl: "/images/kanji/488_discuss_3d.png",
    mnemonic: "Cuộc hội đàm (談) nóng như lửa (炎) cháy.",
    examples: [
      {
        japanese: "相談",
        romaji: "Soudan",
  ...
  },
  {
    ...
    sinoVietnamese: "Án",
    radicals: "安 (an) + 木 (mộc)",
    imageUrl: "/images/kanji/489_proposal_3d.png",
    mnemonic: "Dự án (案) trồng cây (木) an toàn (安).",
    examples: [
      {
        japanese: "案内",
        romaji: "Annai",
  ...
  },
  {
    ...
    imageUrl: "/images/kanji/490_inside_3d.png",
    mnemonic: "Người (人) ở bên trong (内) biên giới (冂).",
    examples: [
      {
        japanese: "家内",
        romaji: "Kanai",
  ...
  },
  {
    ...
    sinoVietnamese: "Quân",
    radicals: "尹 (doãn) + 口 (khẩu)",
    imageUrl: "/images/kanji/491_ruler_3d.png",
    mnemonic: "Vua (君) cầm quyền trượng (尹) ra lệnh bằng miệng (口).",
    examples: [
      {
        japanese: "君",
        romaji: "Kimi",
  ...
  },
  {
    ...
    sinoVietnamese: "Đạt",
    radicals: "辶 (sước) + 羊 (dương) + 土 (thổ)",
    imageUrl: "/images/kanji/492_reach_3d.png",
    mnemonic: "Con cừu (羊) đi (辶) trên đất (土) để đạt (達) đến đích.",
    examples: [
      {
        japanese: "友達",
        romaji: "Tomodachi",
  ...
  },
  {
    ...
    kanji: "星",
    lesson: 31,
    imageUrl: "/images/kanji/493_star_3d.png",
    onyomi: "セイ",
    onyomiRomaji: "sei",
    kunyomi: "ほし",
    kunyomiRomaji: "hoshi",
    meaning: "Ngôi sao",
    sinoVietnamese: "TINH",
    radicals: "日 (nhật) + 生 (sinh)",
    mnemonic: "Mặt trời (日) sinh (生) ra những ngôi sao (星).",
    examples: [],
  },
  {
    id: 494,
    kanji: "雪",
    lesson: 31,
    imageUrl: "/images/kanji/494_snow_3d.png",
    onyomi: "セツ",
    kunyomi: "ゆき",
    meaning: "Tuyết",
  ...
  },
  {
    ...
    radicals: "阝(phụ) + 夅 (hàng)",
    imageUrl: "/images/kanji/495_descend_3d.png",
    mnemonic: "Đi bộ xuống (夅) ngọn đồi (阝) là giáng (降).",
    examples: [
      {
        japanese: "降ります",
        romaji: "Orimasu",
  ...
  },
  {
    ...
    kanji: "直",
    lesson: 31,
    imageUrl: "/images/kanji/496_straight_3d.png",
    onyomi: "チョク, ジキ",
    onyomiRomaji: "choku, jiki",
    kunyomi: "なお.す",
    kunyomiRomaji: "nao-su",
    meaning: "Sửa chữa, Trực tiếp",
    sinoVietnamese: "TRỰC",
    radicals: "十 (thập) + 目 (mục) + 乚 (ất)",
    mnemonic: "Mười (十) con mắt (目) nhìn thẳng (直).",
    examples: [],
  },
  {
    id: 497,
    kanji: "危",
    lesson: 32,
    imageUrl: "/images/kanji/497_danger_3d.png",
    onyomi: "キ",
    onyomiRomaji: "ki",
    kunyomi: "あぶ・ない",
    kunyomiRomaji: "abu-nai",
    meaning: "Nguy, Nguy hiểm",
    sinoVietnamese: "Nguy",
    radicals: "厂 (hán) + 㔾 (tự)",
    mnemonic: "Người ngồi bên vách đá (厂) rất nguy hiểm (危).",
    examples: [
      {
        japanese: "危ない",
        romaji: "Abunai",
  ...
  },
  {
    ...
    onyomiRomaji: "ken",
    kunyomi: "けわ・しい",
    kunyomiRomaji: "kewa-shii",
    meaning: "Hiểm, Hiểm trở, Nguy hiểm",
    sinoVietnamese: "Hiểm",
    radicals: "阝(phụ) + 佥 (kiểm)",
    mnemonic: "Con đường (阝) đầy hiểm trở (険) cần kiểm tra (佥) kỹ.",
    examples: [
      {
        japanese: "危険",
        romaji: "Kiken",
  ...
  },
  {
    ...
    kanji: "拾",
    lesson: 32,
    imageUrl: "/images/kanji/499_pickup_3d.png",
    onyomi: "シュウ",
    onyomiRomaji: "shuu",
    kunyomi: "ひろ・う",
    kunyomiRomaji: "hiro-u",
    meaning: "Thập, Nhặt",
    sinoVietnamese: "Thập",
    radicals: "扌(thủ) + 合 (hợp)",
    mnemonic: "Dùng tay (扌) gom (合) đồ lại là nhặt (拾).",
    examples: [
      {
        japanese: "拾います",
        romaji: "Hiroimasu",
  ...
  },
  {
    ...
    kanji: "捨",
    lesson: 32,
    imageUrl: "/images/kanji/500_discard_3d.png",
    onyomi: "シャ",
    onyomiRomaji: "sha",
    kunyomi: "す・てる",
    kunyomiRomaji: "su-teru",
    meaning: "Xả, Vứt bỏ",
    sinoVietnamese: "Xả",
    radicals: "扌(thủ) + 舎 (xá)",
    mnemonic: "Dùng tay (扌) vứt bỏ (捨) đồ khỏi nhà (舎).",
    examples: [
      {
        japanese: "捨てます",
        romaji: "Sutemasu",
  ...
  },
  {
    ...
    kanji: "戻",
    lesson: 32,
    imageUrl: "/images/kanji/501_return_3d.png",
    onyomi: "レイ",
    onyomiRomaji: "rei",
    kunyomi: "もど・る",
    kunyomiRomaji: "modo-ru",
    meaning: "Lệ, Quay lại",
    sinoVietnamese: "Lệ",
    radicals: "戶 (hộ) + 大 (đại)",
    mnemonic: "Cửa nhà (戶) mở to (大) để quay về (戻).",
    examples: [
      {
        japanese: "戻ります",
        romaji: "Modorimasu",
  ...
  },
  {
    ...
    kanji: "吸",
    lesson: 32,
    imageUrl: "/images/kanji/502_inhale_3d.png",
    onyomi: "キュウ",
    onyomiRomaji: "kyuu",
    kunyomi: "す・う",
    kunyomiRomaji: "su-u",
    meaning: "Hấp, Hút",
    sinoVietnamese: "Hấp",
    radicals: "口 (khẩu) + 及 (cập)",
    mnemonic: "Miệng (口) hít vào (及) là hút (吸).",
    examples: [
      {
        japanese: "吸います",
        romaji: "Suimasu",
  ...
  },
  {
    ...
    kanji: "放",
    lesson: 32,
    imageUrl: "/images/kanji/503_release_3d.png",
    onyomi: "ホウ",
    onyomiRomaji: "hou",
    kunyomi: "はな・す",
    kunyomiRomaji: "hana-su",
    meaning: "Phóng, Buông",
    sinoVietnamese: "PHÓNG",
    radicals: "方 (phương) + 攵 (phộc)",
    mnemonic: "Tay cầm gậy (攵) đánh theo mọi phương (方) là phóng ra (放).",
    examples: [],
  },
  {
    id: 504,
    kanji: "変",
    lesson: 32,
    imageUrl: "/images/kanji/504_change_3d.png",
    onyomi: "ヘン",
    onyomiRomaji: "hen",
    kunyomi: "か・わる",
    kunyomiRomaji: "ka-waru",
    meaning: "Biến đổi, Lạ",
    sinoVietnamese: "BIẾN",
    radicals: "亦 (diệc) + 夂 (truy)",
    mnemonic: "Mọi thứ (亦) theo thời gian (夂) đều thay đổi (変).",
    examples: [],
  },
  {
    id: 505,
    kanji: "街",
    lesson: 32,
    imageUrl: "/images/kanji/505_street_3d.png",
    onyomi: "ガイ",
    onyomiRomaji: "gai",
    kunyomi: "まち",
    kunyomiRomaji: "machi",
    meaning: "Phố",
    sinoVietnamese: "NHA",
    radicals: "行 (hành) + 圭 (khuê)",
    mnemonic: "Con đường (行) với nhiều nhà (圭圭) là phố (街).",
    examples: [],
  },
  {
    id: 506,
    kanji: "髪",
    lesson: 32,
    imageUrl: "/images/kanji/506_hair_3d.png",
    onyomi: "ハツ",
    onyomiRomaji: "hatsu",
    kunyomi: "かみ",
    kunyomiRomaji: "kami",
    meaning: "Tóc",
    sinoVietnamese: "PHÁT",
    radicals: "髟 (bưu) + 彡 (sam)",
    mnemonic: "Dấu tóc dài (髟) với vài sợi rụng (彡) là tóc (髪).",
    examples: [],
  },
  {
    id: 507,
    kanji: "絵",
    lesson: 32,
    imageUrl: "/images/kanji/507_picture_3d.png",
    onyomi: "カイ, エ",
    onyomiRomaji: "kai, e",
    kunyomi: "-",
    kunyomiRomaji: "-",
    meaning: "Tranh",
    sinoVietnamese: "HỘI",
    radicals: "糸 (mịch) + 会 (hội)",
    mnemonic: "Dùng chỉ (糸) để vẽ họa (会) thành tranh (絵).",
    examples: [],
  },
  {
    id: 508,
    kanji: "横",
    lesson: 32,
    imageUrl: "/images/kanji/508_horizontal_3d.png",
    onyomi: "オウ",
    onyomiRomaji: "ou",
    kunyomi: "よこ",
    kunyomiRomaji: "yoko",
    meaning: "Ngang",
    sinoVietnamese: "HOÀNH",
    radicals: "木 (mộc) + 黄 (hoàng)",
    mnemonic: "Cây gỗ (木) nằm ngang (横) như vàng (黄) rơi.",
    examples: [],
  },
  {
    id: 509,
    kanji: "当",
    lesson: 32,
    imageUrl: "/images/kanji/509_hit_3d.png",
    onyomi: "トウ",
    onyomiRomaji: "tou",
    kunyomi: "あ・たる",
    kunyomiRomaji: "a-taru",
    meaning: "Đương, Trúng",
    sinoVietnamese: "ĐƯƠNG",
    radicals: "⺌ (tiểu) + 田 (điền)",
    mnemonic: "Bắn trúng (当) vào ruộng (田).",
    examples: [],
  },
  {
    id: 510,
    kanji: "伝",
    lesson: 32,
    imageUrl: "/images/kanji/510_transmit_3d.png",
    onyomi: "デン",
    onyomiRomaji: "den",
    kunyomi: "つた・える",
    kunyomiRomaji: "tsuta-eru",
    meaning: "Truyền, Truyền đạt",
    sinoVietnamese: "Truyền",
    radicals: "亻(nhân) + 云 (vân)",
    mnemonic: "Người (亻) nói (云) để truyền đạt (伝).",
    examples: [
      {
        japanese: "伝えます",
        romaji: "Tsutaemasu",
  ...
  },
  {
    ...
    kanji: "細",
    lesson: 32,
    imageUrl: "/images/kanji/511_thin_3d.png",
    onyomi: "サイ",
    onyomiRomaji: "sai",
    kunyomi: "ほそ・い",
    kunyomiRomaji: "hoso-i",
    meaning: "Nhỏ, Mịn",
    sinoVietnamese: "TẾ",
    radicals: "糸 (mịch) + 田 (điền)",
    mnemonic: "Sợi chỉ (糸) nhỏ như đường ô ruộng (田) là mảnh (細).",
    examples: [],
  },
  {
    id: 512,
    kanji: "無",
    lesson: 32,
    imageUrl: "/images/kanji/512_nothing_3d.png",
    onyomi: "ム, ブ",
    onyomiRomaji: "mu, bu",
    kunyomi: "な・い",
    kunyomiRomaji: "na-i",
