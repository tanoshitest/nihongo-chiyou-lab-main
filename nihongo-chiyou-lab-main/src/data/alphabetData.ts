  ...
  hiragana: [
    // Row A - Full
    {
      id: 'h_a', char: 'あ', romaji: 'a', image: 'https://placehold.co/100?text=Ant', examples: [
        { ja: 'あり', romaji: 'ari', vi: 'Con kiến', image: 'https://placehold.co/100?text=Ant' },
    ...
    {
      id: 'h_i', char: 'い', romaji: 'i', image: 'https://placehold.co/100?text=Dog', examples: [
        { ja: 'いぬ', romaji: 'inu', vi: 'Con chó', image: 'https://placehold.co/100?text=Dog' },
    ...
    {
      id: 'h_u', char: 'う', romaji: 'u', image: 'https://placehold.co/100?text=Cow', examples: [
        { ja: 'うし', romaji: 'ushi', vi: 'Con bò', image: 'https://placehold.co/100?text=Cow' },
    ...
    {
      id: 'h_e', char: 'え', romaji: 'e', image: 'https://placehold.co/100?text=Pencil', examples: [
        { ja: 'えんぴつ', romaji: 'enpitsu', vi: 'Bút chì', image: 'https://placehold.co/100?text=Pencil' },
    ...
    {
      id: 'h_o', char: 'お', romaji: 'o', image: 'https://placehold.co/100?text=RiceBall', examples: [
        { ja: 'おにぎり', romaji: 'onigiri', vi: 'Cơm nắm', image: 'https://placehold.co/100?text=RiceBall' },
